#region Licensing
// ---------------------------------------------------------------------
// <copyright file="Ghostblade.cs" company="EloBuddy">
// 
// Marksman Master
...
namespace Marksman_Master.Activator.Items
{
    ...
    internal class Ghostblade : Item
    {
        public Ghostblade()
        {
            ...
            Range = Player.Instance.GetAutoAttackRange();
        }

        public static bool IsOwned { get; } =
            Player.Instance.InventoryItems.Any(x => x.Id == EloBuddy.ItemId.Youmuus_Ghostblade);
    }
}