#region Licensing
// ---------------------------------------------------------------------
// <copyright file="HealthPotion.cs" company="EloBuddy">
// 
// Marksman Master
...
namespace Marksman_Master.Activator.Items
{
    ...
    internal sealed class HealthPotion : Item
    {
        ...
        public static bool IsOwned { get; } =
            Player.Instance.InventoryItems.Any(x => x.SpellSlot != SpellSlot.Unknown && (x.Id == EloBuddy.ItemId.Health_Potion || x.Id == EloBuddy.ItemId.Total_Biscuit_of_Rejuvenation));
    }
}