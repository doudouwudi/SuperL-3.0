...
namespace LeagueSharp.SDK
{
    ...
    public class TeleportEventArgs : EventArgs
    {
        ...
        ///     <c>summoner</c> Teleport, or <see cref="AIHeroClient" /> is target of a <c>shen</c> ultimate.
        /// </summary>
        public bool IsTarget { get; internal set; }

        /// <summary>
        ///     Gets the <see cref="AIHeroClient" /> who is teleporting or is the target of a teleport.
        /// </summary>
