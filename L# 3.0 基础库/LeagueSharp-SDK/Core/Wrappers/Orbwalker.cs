namespace LeagueSharp.SDK
{
    ...
    public sealed class Orbwalker
    {
                    ...
                    if (value)
                    {
                        ...
                        switch (GameObjects.Player.ChampionName)
                        {
                            case "Azir":
                                ...
                                Obj_AI_Base.OnBuffGain += this.AzirOnBuffAdd;
        ...
        private void AzirOnBuffAdd(Obj_AI_Base sender, Obj_AI_BaseBuffGainEventArgs args)
        {
        ...
        private void OnStopCast(Obj_AI_Base spellbook, SpellbookStopCastEventArgs args)
        {
            if (!spellbook.IsMe)
            {
                return;
