...
namespace Karthus
{
    ...
    internal class Program
    {
        ...
        {
            if (!E.IsReady() || player.IsZombie || !Player.Instance.HasBuff("KarthusDefile"))
            {
                return;
            }
        ...
        {
            {
                    ...
                    && !player.IsZombie)
                {
                    ...
                    if ((!Player.Instance.HasBuff("KarthusDefile") && (minions.Count >= 1 || jgm))
                        && (player.ManaPercent >= HarassMenu.Get<Slider>("HEPercent").CurrentValue))
                    {
                        E.Cast();
                    }
                    else if ((Player.Instance.HasBuff("KarthusDefile") && (minions.Count == 0 && !jgm))
                             || !(player.ManaPercent >= HarassMenu.Get<Slider>("HEPercent").CurrentValue))
                    {
                        calcE(true);
                    }
                ...
                if (HarassMenu.Get<CheckBox>("HUse_E").CurrentValue && E.IsReady() && !player.IsZombie)
                {
                    if (HarassMenu.Get<CheckBox>("HE_Auto_False").CurrentValue)
                    {
                        if (eTarget != null)
                        {
                            if (!Player.Instance.HasBuff("KarthusDefile"))
                            {
        ...
        private static bool Combo()
        {
            ...
            if (flags.HasFlag(Orbwalker.ActiveModes.Combo) && menuIni.Get<CheckBox>("Combo").CurrentValue)
            {
                ...
                {
                    if (eTarget == null && Player.Instance.HasBuff("KarthusDefile"))
                    {
                        E.Cast();
                    }
                    ...
                    if (eTarget != null)
                    {
                        ...
                        {
                            if (eTarget.IsValidTarget(E.Range) && !Player.Instance.HasBuff("KarthusDefile"))
                            {
                                E.Cast();
                            }
                        }
